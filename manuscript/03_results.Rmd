...
The strength of the correlations of $N$ with photosynthetic parameters $V_{c,max}$ and $J_{max}$ varied by PFT, regardless of whether the traits were normalized by mass or area.
