...
A demonstration of this multiple imputation approach and how it is used to estimate trait covariance is provided in a literate programming vignette in the supplementary information to this manuscript.
...
and can be retrieved by providing the request ID (#1584).
