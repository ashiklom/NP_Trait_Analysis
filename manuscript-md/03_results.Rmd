...
table_dat <- means_dat %>%
  ...
  mutate(
    ...
    value = if_else(grepl("Vcmax|Jmax", param) & pft == "C4G", "---", value)
  ) %>%
...
plot_dat <- means_dat %>%
  mutate(
    ...
    mu_hi = pclip(param, "Rdarea", mu_hi, 0.0035),
    mu_mean = pclip(param, "Rdarea", mu_mean, 0.0035),
    mu_lo = pclip(param, "Rdarea", mu_lo, 0.0035),
...
```{r boxprep}
hier_mass_file <- "../output/hier.mass.clm45.NA.2017-11-13-1250.rds"
hier_area_file <- "../output/hier.area.clm45.NA.2017-11-13-1312.rds"
multi_mass_file <- "../output/multi.mass.clm45.NA.2017-11-13-1231.rds"
multi_area_file <- "../output/multi.area.clm45.NA.2017-11-13-1245.rds"
