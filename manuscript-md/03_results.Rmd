...
plot_dat <- means_dat %>%
  mutate(
    ...
    mu_mean = pclip(param, "Rdarea", mu_mean, 1.7),
    mu_lo = pclip(param, "Rdarea", mu_lo, 0.5, FALSE),
...
```{r boxprep}
hier_mass_file <- "../output/hier.mass.clm45.NA.2017-11-09-1749.rds"
hier_area_file <- "../output/hier.area.clm45.NA.2017-11-10-0937.rds"
multi_mass_file <- "../output/multi.mass.clm45.NA.2017-11-09-1733.rds"
multi_area_file <- "../output/multi.area.clm45.NA.2017-11-09-1741.rds"
