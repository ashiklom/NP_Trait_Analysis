...
The code for fitting these models to arbitrary data is available as an open source R package (`mvtraits`) at <http://github.com/ashiklom/mvtraits>.
...
If all three models perform equally well at all sample sizes, their respective slope coefficients would be statistically indistinguishable.
