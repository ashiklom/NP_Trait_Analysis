...
* NP traits tasks
** NEXT Supplemental table of sample sizes for each trait in each functional group
** NEXT Supplemental table of all pairwise correlations for data in figures
   - Covariance
   - Correlation
   - Sample size of empirical data
   - Sample size after imputation
** NEXT Multiple imputation vignette
